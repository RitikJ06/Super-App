...
export default function () {
  ...
  const reduceMinutes = () => {
    minutes > 0
      ...
      : hours > 0
      ? setHours(hours - 1) || setminutes(59)
      : setminutes(minutes);
  };
  ...
  const reduceSecs = () => {
    secs > 0
      ? setSecs(secs - 1)
      : minutes > 0
      ? setminutes(minutes - 1) || setSecs(59)
      : hours > 0
      ? setHours(hours - 1) || setminutes(59) || setSecs(59)
      : setminutes(minutes);
  };
  ...
  const playTimer = () => {
    ...
    setTotalCurrentSecs(
      (totalUpdatedCurrentSecs) => totalUpdatedCurrentSecs - 1
    );
    ...
    <div className={styles.timerSection}>
      <div className={styles.timerWrapper}>
        <CircularProgressbar
          ...
          text={
            Math.floor(totalCurrentSecs / 3600)
              .toString()
              .padStart(2, "0") +
            ":" +
            Math.floor((totalCurrentSecs % 3600) / 60)
              .toString()
              .padStart(2, "0") +
            ":" +
            (totalCurrentSecs % 60).toString().padStart(2, "0")
          }
        />
      </div>
          ...
          <div className={styles.timerInput}>
            ...
            <img
              ...
              onClick={() => {
                secs == 59
                  ? minutes == 59
                    ? setHours(hours + 1) || setminutes(0) || setSecs(0)
                    : setminutes(minutes + 1) || setSecs(0)
                  : setSecs(secs + 1);
              }}
            />
